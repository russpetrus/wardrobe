...
namespace WardrobeApp.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoryID,Name,Color,Type,Season,Occasion,Photo")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryID,Name,Color,Type,Season,Occasion,Photo")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
