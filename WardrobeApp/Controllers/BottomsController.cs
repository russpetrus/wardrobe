...
namespace WardrobeApp.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,Name,Color,Type,Season,Occasion,Photo")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,Name,Color,Type,Season,Occasion,Photo")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
