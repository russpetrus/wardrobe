...
namespace WardrobeApp.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoeID,Name,Color,Type,Season,Occasion,Photo")] Sho sho)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoeID,Name,Color,Type,Season,Occasion,Photo")] Sho sho)
        {
            if (ModelState.IsValid)
            {
