...
namespace WardrobeApp.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopID,Name,Color,Type,Season,Occasion,Photo")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,Name,Color,Type,Season,Occasion,Photo")] Top top)
        {
            if (ModelState.IsValid)
            {
